          ...
          <div className="main8">
            ...
            <div className="main9 ">
              <div className="main24">
                <img
                  className="img23"
                  src="https://img.freepik.com/free-photo/business-woman-working-in-office-on-computer_1303-28023.jpg?w=740&t=st=1670054008~exp=1670054608~hmac=3bff411bc801892e20d2c8ad0ac28d0e7b8d33973d0eee8ae3e55464f759f95f"
                  alt=""
                />
                <div className="main25">
                  <FaStar className="star" />
              ...
              <div className="main12">
                ...
                <h4 className="h44">Высшая категория</h4>
                <h4 className="h45">
                  <FaMoneyBillWave className="icon-money" /> от 270000.00 сум
                </h4>
                <h4 className="h46">Запись на приём:</h4>
                <h4 className="h47">
